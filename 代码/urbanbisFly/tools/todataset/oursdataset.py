...
class CustomDataset(Dataset):
    ...
    def __init__(self, pkl_file_path, occ_size, pc_range, use_semantic=False, classes=None, overlap_test=False, *args,
        ...
        # 获取数据长度
        self.length = len(self.data['img_filename'])
    ...
    def __getitem__(self, idx):
        # 获取每个索引的数据
        filename = self.data['img_filename'][idx]
...
# 创建Dataset对象
dataset = CustomDataset(pkl_file_path = pkl_file_path,occ_size = [300,150,300],pc_range = [-150,-50,-150,150,100,150])
